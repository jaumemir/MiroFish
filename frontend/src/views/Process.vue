            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes content and auto-generates an ontology structure suitable for opinion simulation (entity types + relation types)
                </div>
              </div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Entity types generated ({{ projectData.ontology.entity_types?.length || 0 }})</div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Relation types generated ({{ projectData.ontology.relation_types?.length || 0 }})</div>
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Auto-start graph build (también si falló sin graph_id pero con ontología)
      const canRetryBuild = (
...
const renderGraph = () => {
  ...
  // Draw edges (including transparent wide click target)
  ...
  // Close detail panel on blank click
  svg.on('click', () => {
    closeDetailPanel()
  })
  
  simulation.on('tick', () => {
    // Update positions for all edges (visible and transparent click areas)
