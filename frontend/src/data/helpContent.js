  ...
  en: {
    ...
    step3: {
      ...
      body: [
        ...
        { type: 'h3', text: 'Stopping and resuming' },
        { type: 'p', text: 'Click "Stop simulation" to pause at any point. Partial results are saved. Click "Resume simulation" to continue from where it stopped. You can also generate a report from partial results.' },
  ...
  ca: {
    ...
    step3: {
      ...
      body: [
        ...
        { type: 'h3', text: 'Aturar i reprendre' },
        { type: 'p', text: 'Clica "Atura la simulació" per pausar-la en qualsevol moment. Els resultats parcials es guarden. Clica "Reprèn la simulació" per continuar des d\'on s\'havia aturat. També pots generar un informe dels resultats parcials.' },
  ...
  es: {
    ...
    step3: {
      ...
      body: [
        ...
        { type: 'h3', text: 'Detener y reanudar' },
        { type: 'p', text: 'Haz clic en "Detener simulación" para pausarla en cualquier momento. Los resultados parciales se guardan. Haz clic en "Reanudar simulación" para continuar desde donde se detuvo. También puedes generar un informe de los resultados parciales.' },
