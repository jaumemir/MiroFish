...
Haz clic en la imagen para ver la predicción profunda de MiroFish del final perdido basada en cientos de miles de palabras de los primeros 80 capítulos de "Sueño de las Cámaras Rojas"
</div>
...
> La dirección del mirror para descarga más rápida se proporciona como comentarios en `docker-compose.yml`, reemplaza si es necesario.
...
El equipo de MiroFish está reclutando posiciones de tiempo completo/pasantías. Si te interesan la simulación multi-agente y las aplicaciones de LLM, no dudes en enviar tu CV a: **mirofish@shanda.com**
